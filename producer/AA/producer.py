...
try:
    ...
    print(f"Successfully retrieved Kafka username: {kafka_username}")  # Debug log
    ...
    print(f"Successfully retrieved Kafka password")  # Note: avoid printing sensitive data like passwords in production logs
