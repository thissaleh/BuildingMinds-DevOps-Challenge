...
kafka_topic = os.getenv("KAFKA_BROKER", "kafka.default.svc.cluster.local:9092")
kafka_broker = os.getenv("KAFKA_TOPIC", "posts")
kafka_username = os.getenv("KAFKA_USERNAME", "user1")
secret_name = os.getenv("SECRET_NAME", "kafka-user-passwords")
